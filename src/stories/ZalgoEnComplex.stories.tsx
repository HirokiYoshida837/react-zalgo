...
GlitchAmountControll.args = {
  textData:
    'You can controll the amount of glitching with function. abcdefghijklmnopqrstuvwxyz',
  glitchParams: {
...
ReproducibleGlitch.args = {
  textData:
    'If you click "Rerun Interactions", the glitched result will be not changed. abcdefghijklmnopqrstuvwxyz',
  glitchParams: {
